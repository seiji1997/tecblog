...
function extractScriptTags(scripts) {
    ...
    const moduleScripts = scripts
        .filter((script) => script.type === "module" /* ExtractedScriptType.Module */ ||
        script.type === "processed-module" /* ExtractedScriptType.ProcessedModule */)
    ...
    script.type === "event-attribute" /* ExtractedScriptType.EventAttribute */ ||
        script.type === "inline" /* ExtractedScriptType.Inline */ ||
        script.type === "unknown" /* ExtractedScriptType.Unknown */)
    ...
    const JSONScripts = scripts
        .filter((script) => script.type === "json" /* ExtractedScriptType.Json */)
...
function moduleScriptToVirtualCode(script, index) {
    ...
    if (script.type === "module" /* ExtractedScriptType.Module */) {
        extension = 'mjs';
