        ...
        create(context) {
            return {
                ...
                provideDiagnostics(document, token) {
                    ...
                    function compilerMessageToDiagnostic(diagnostic) {
                        return {
                            message: diagnostic.message,
                            range: language_server_1.Range.create(document.positionAt(diagnostic.position.start), document.positionAt(diagnostic.position.end)),
